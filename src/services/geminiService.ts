...
const SKILL_CATEGORY_MAP: Record<string, SkillCategory> = {
  ...
  'CSS / Tailwind': 'frontend', 'JavaScript': 'frontend', 'TypeScript': 'frontend', 'Next.js': 'frontend',
  // Backend
  'Node.js': 'backend', 'Python': 'backend', 'Java': 'backend', 'Go': 'backend',
  'Django / FastAPI': 'backend', 'REST API Design': 'backend', 'PostgreSQL': 'backend', 'MongoDB': 'backend',
  // Mobile
  'React Native': 'frontend', 'Flutter': 'frontend', 'iOS (Swift)': 'frontend', 'Android (Kotlin)': 'frontend', 'Expo': 'frontend',
  // Cloud / DevOps
  'AWS': 'cloud', 'Azure': 'cloud', 'GCP': 'cloud', 'Google Cloud': 'cloud',
  'Docker': 'devops', 'Kubernetes': 'devops', 'CI/CD': 'devops', 'CI/CD Pipelines': 'devops', 'Terraform': 'devops',
  // Architecture / SE
  'System Design': 'architect', 'Microservices': 'architect',
  'Data Structures & Algorithms': 'architect', 'Security Best Practices': 'architect',
  // Developer Relations
  'Technical Writing': 'generalist', 'API Documentation': 'generalist',
  'Community Management': 'generalist', 'Developer Advocacy': 'generalist',
  // Customer Service
  'Customer Support Representative': 'customer_service', 'Call Center Agent': 'customer_service',
  'Help Desk / IT Support': 'customer_service', 'Client Success Manager': 'customer_service',
  'Live Chat Support': 'customer_service', 'Help Desk Support': 'customer_service',
  // Sales
  'Sales Representative': 'sales', 'Sales Development Representative (SDR)': 'sales',
  'Business Development': 'sales', 'Account Executive': 'sales',
  'Lead Generation': 'sales', 'Cold Outreach / Email Sales': 'sales',
  // Marketing
  'Digital Marketing': 'marketing', 'Social Media Manager': 'marketing', 'Social Media Management': 'marketing',
  'Content Creator': 'marketing', 'Content Creation & Strategy': 'marketing',
  'SEO Specialist': 'marketing', 'SEO & SEM': 'marketing',
  'Email Marketing': 'marketing', 'Paid Advertising (Meta/Google)': 'marketing', 'Influencer Marketing': 'marketing',
  // Admin / VA / E-Commerce
  'Virtual Assistant': 'admin', 'Executive Virtual Assistant': 'admin', 'Administrative VA': 'admin',
  'Research & Data VA': 'admin', 'Calendar & Email Management': 'admin', 'Client Onboarding VA': 'admin',
  'Executive Assistant': 'admin', 'Data Entry Specialist': 'admin', 'Office Administrator': 'admin',
  'Shopify Management': 'admin', 'Amazon Seller Central': 'admin',
  'Product Listing Optimization': 'admin', 'Order Fulfilment & Logistics': 'admin', 'Customer Returns Handling': 'admin',
  // Project Management / HR
  'Project Manager': 'generalist', 'Scrum Master / Agile': 'generalist', 'Operations Manager': 'generalist',
  'Program Coordinator': 'generalist', 'HR Coordinator': 'generalist', 'Talent Sourcing': 'generalist',
  'Technical Recruiter': 'generalist', 'Onboarding Specialist': 'generalist',
  'Quality Assurance': 'generalist', 'Recruiter': 'generalist',
  // Communication
  'Public Speaking': 'communication', 'Presentation Skills': 'communication',
  'Business Writing': 'communication', 'Negotiation': 'communication', 'Active Listening': 'communication',
  // Office Tools
  'Microsoft Excel': 'office_tools', 'Microsoft Word': 'office_tools', 'Microsoft PowerPoint': 'office_tools',
  'Google Workspace': 'office_tools', 'Notion / Airtable': 'office_tools',
};
