...
export const EnterpriseDashboard: React.FC<EnterpriseDashboardProps> = ({
    ...
    const handleDownload = () => {
        ...
        const rows = [
            ['Metric', 'Value'],
            ['Active Jobs', analytics.hiringMetrics.activeJobPosts],
            ['Total Applications', analytics.hiringMetrics.totalApplications],
            ['Candidates Screened', analytics.hiringMetrics.candidatesScreened],
            ['Offer Acceptance Rate (%)', analytics.hiringMetrics.offerAcceptanceRate],
            ['Avg. Time to Hire (days)', analytics.hiringMetrics.averageTimeToHire],
            ['Cost per Hire ($)', analytics.hiringMetrics.costPerHire],
            ['Avg. Skill Score (%)', analytics.talentPool.averageScore],
            ['Verified Candidates', analytics.talentPool.verifiedCandidates],
        ];
        ...
        a.href = url;
        a.download = `lune-analytics-${dateRange}-${new Date().toISOString().split('T')[0]}.csv`;
        a.click();
    ...
    if (error) return (
        <div className="min-h-screen bg-gray-50 flex items-center justify-center">
            <div className="text-center">
                ...
                <button onClick={() => { setError(null); loadAnalytics(); }} className="px-4 py-2 bg-teal-600 text-white rounded-lg">
                    Try Again
                </button>
            </div>
        </div>
    ...
    const hasNoCandidates = analytics.hiringMetrics.totalApplications === 0;
    const funnelMetrics = calculateFunnelMetrics(analytics.pipeline);

    return (
        <div className="min-h-screen bg-gray-50">
            {/* Header */}
            <header className="bg-white/95 backdrop-blur-md border-b border-gray-200 sticky top-0 z-40 shadow-md">
                <div className="max-w-7xl mx-auto px-6 py-4">
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <button className="p-2 hover:bg-gray-100 rounded-lg transition" onClick={handleDownload}>
                    ...
                    {/* Tabs */}
                    <div className="flex gap-6 mt-4 -mb-px" role="tablist">
                        {[
            ...
            <main className="max-w-7xl mx-auto px-6 py-8">
                {hasNoCandidates ? (
                    <div className="flex flex-col items-center justify-center py-24 text-center">
                        ...
                        <h3 className="text-xl font-bold text-gray-900 mb-2">No candidate data yet</h3>
                        <p className="text-gray-500 max-w-sm">
                            Once candidates start applying and completing assessments, your analytics will appear here.
                        </p>
                    </div>
                ) : (
