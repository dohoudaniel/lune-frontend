...
export const AICareerCoach: React.FC<AICareerCoachProps> = ({
  ...
  const fetchCareerPaths = useCallback(async () => {
    ...
    setPathsError(null);
    try {
      const { jobs, certifications } =
        await getCareerRecommendations(currentSkills);
      setPathJobs(jobs);
  ...
  const sendMessage = async (text: string) => {
    ...
    try {
      ...
      const certifications: RecommendedCertification[] =
...
${jobs
  ...
  .map(
    (j) =>
      `• **${j.title}** at ${j.company}${j.salary ? ` — ${j.salary}` : ""}${j.location ? ` (${j.location})` : ""}`,
  )
  .join("\n")}`);
        }
...
${certifications
  .slice(0, 3)
  .map((c) => `• **${c.name}** (${c.provider}) — ${c.reason}`)
  .join("\n")}`);
        }
      ...
      setChatError(
        "The career coach could not respond right now. Please try again.",
      );
            ...
            <div className="flex gap-1 bg-gray-100 p-1 rounded-lg">
              {[
                ...
                <button
                  ...
                  onClick={() =>
                    setActiveTab(
                      tab.id as "chat" | "paths" | "salary" | "resume",
                    )
                  }
              ...
              {messages.map((message) => (
                ...
                >
                  ...
                  >
                    ...
                    >
                      <div
                        className={`whitespace-pre-wrap ${message.role === "coach" ? "prose prose-sm max-w-none" : ""}`}
                      >
                        {message.content}
                      </div>
                    </div>
          ...
          <div className="h-full overflow-y-auto p-6">
            <div className="max-w-4xl mx-auto">
              ...
              <p className="text-gray-500 mb-6">
                Personalised opportunities based on your verified skills
              </p>
              ...
              {!pathsLoading && !pathsError && pathJobs.length === 0 && (
                <div className="text-center py-16 text-gray-400">
                  ...
                  <p className="text-sm mt-1">
                    Complete more skill assessments to unlock personalised
                    career paths.
                  </p>
                </div>
              )}
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="flex items-start gap-3 bg-amber-50 border border-amber-200 rounded-xl p-4 mb-6">
                ...
                <p className="text-sm text-amber-800">
                  Salary figures vary widely by location, company size, and
                  negotiation. We recommend cross-referencing with live market
                  data on{" "}
                  <a
                  ...
                  , or{" "}
                  <a
                    href="https://linkedin.com/salary"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="underline font-medium"
                  >
                  ...
                  for accurate, up-to-date ranges for your specific role and
                  region.
                </p>
              </div>
                ...
                <div className="bg-white rounded-xl border border-gray-200 p-6">
                  ...
                  <ul className="space-y-3">
                    <li className="flex items-start gap-3">
                      ...
                      <div>
                        <p className="font-medium text-gray-900">
                          Earn a sought-after certification
                        </p>
                        <p className="text-sm text-gray-500">
                          Cloud, security, and data certs command measurable
                          premiums
                        </p>
                      </div>
                    </li>
                    <li className="flex items-start gap-3">
                      ...
                      <div>
                        <p className="font-medium text-gray-900">
                          Build a quantified portfolio
                        </p>
                        <p className="text-sm text-gray-500">
                          Show measurable business outcomes, not just tasks
                          completed
                        </p>
                      </div>
                    </li>
                    <li className="flex items-start gap-3">
                      ...
                      <div>
                        <p className="font-medium text-gray-900">
                          Cultivate competing offers
                        </p>
                        <p className="text-sm text-gray-500">
                          Multiple offers are the single strongest negotiation
                          lever
                        </p>
                      </div>
                    </li>
                    <li className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-500">
                          Remote roles at top-tier firms often pay above local
                          market rates
                        </p>
                      </div>
                    </li>
              ...
              <div className="mt-6 bg-indigo-50 rounded-xl p-5 text-center">
                ...
                <p className="text-indigo-700 text-sm mt-1">
                  Ask the Career Coach — type your question in the Chat tab and
                  it will pull live data from the backend.
                </p>
                <button
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="bg-white rounded-xl border-2 border-dashed border-indigo-200 p-12 text-center mb-6">
                ...
                <p className="text-gray-500 max-w-sm mx-auto">
                  Your AI Skill Passport already captures your verified,
                  proctored skills. Full resume upload and line-by-line AI
                  feedback will be available in an upcoming release.
                </p>
