...
export const NotificationBell: React.FC<NotificationBellProps> = ({
  ...
  useEffect(() => {
    ...
    const initialNotifs = notificationService.getNotifications(userId);
    setNotifications(initialNotifs);
    updateUnreadCount(initialNotifs);

    // Subscribe to cache changes (SSE-driven updates)
    unsubscribeRef.current = notificationService.onCacheChange(
      (updatedNotifs) => {
