...
export const EmployerDashboard: React.FC<EmployerDashboardProps> = ({
   ...
   useEffect(() => {
      const loadData = async () => {
         try {
             const [fetchedCandidates, fetchedJobs, fetchedProfile] = await Promise.all([
             ...
             if (fetchedProfile) {
                 const newProfile = {
                    ...
                    website: (fetchedProfile as any).website || 'https://techcorpglobal.com',
                    location: (fetchedProfile as any).location || 'San Francisco, CA',
                    about: (fetchedProfile as any).about || 'Leading technology company focused on innovation and growth.',
                 };
                                    ...
                                    viewingCandidate.certifications.map((hash, idx) => (
                                       ...
                                       >
                                          <div className="flex items-start gap-4">
                                             ...
                                             <div>
                                                <h4 className="font-bold text-slate-900">Certificate of Competence</h4>
                                 ...
                                 <div className="mt-8 bg-blue-50 border border-blue-100 rounded-xl p-4 flex gap-3 items-start">
                                    ...
                                    <div>
                                       ...
                                       <p className="text-blue-800/80 text-xs mt-1">
                                          These certificates are cryptographically verified and tamper-proof, serving as proof of the candidate's skill assessment performance.
                                       </p>
                                    </div>
                                 </div>
                              </motion.div>
